    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '₦14,700.00',
            style: AppTextStyles.h2Sb.copyWith(color: theme.neutral.primaryText),
          ),
            ...
            children: [
                ...
                child: ElevatedButton.icon(
                  ...
                  icon: SvgPicture.asset(
                    ...
                    colorFilter: ColorFilter.mode(
                        theme.neutral.buttonTextWhite, BlendMode.srcIn),
                  ),
                  label: const Text('New Dispense'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: theme.pharmacist.bg,
                    foregroundColor: theme.neutral.buttonTextWhite,
                    shape: RoundedRectangleBorder(
                      borderRadius:
                          BorderRadius.circular(context.figmaWidth(8)),
                    ),
              ...
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Dispense History'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: theme.pharmacist.bg,
                    foregroundColor: theme.neutral.buttonTextWhite,
                    shape: RoundedRectangleBorder(
